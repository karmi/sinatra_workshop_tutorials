...
Collection of small apps to demonstrate Sinatra and it's world.

== Contents

=== Rack <i>(tags 1 - 3)</i>
Demonstrating basic Rack concepts in <tt>01_rack</tt>.

=== Sinatra features <i>(tags 4 - 17)</i>
Demonstrating Sinatra concepts and features in <tt>02_sinatra_features</tt>
...
Demonstrating use Sinatra as a Rails Metal application in <tt>04_sinatra_metal</tt>

== Tutorial

Open the commits listing either locally or on _Github_ to have an overview what's going on.

Every important step of the tutorial is saved in _Git_ tags.
...
(c) 2009 Karel Minarik under MIT licence
